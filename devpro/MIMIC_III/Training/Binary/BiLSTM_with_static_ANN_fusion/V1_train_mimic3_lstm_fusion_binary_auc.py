#!/usr/bin/env python3
"""
V1_train_mimic3_lstm_fusion_binary_auc.py
---------------------------------------

MIMIC-III BiLSTM + Static ANN Fusion Binary LOS training script
...
Outputs:
    /lustre/home/rahas2/mimic_projects/outputs/mimic3_lstm_fusion_binary_auc_models_v1

Run:
    python V1_train_mimic3_lstm_fusion_binary_auc.py --workers 0 --batch 128
"""
...
OUT_DIR = os.path.join(_PROJECT_ROOT, "results_LOS_dynamic", "mimic3_lstm_fusion_binary_auc_models_v1")
...
class FusionLSTMBinary(nn.Module):
    def __init__(
        ...
        self.head = build_standard_head(fusion_in_dim, n_classes=2)
...
def main():
    ...
    print("USING MIMIC-III LSTM + ANN FUSION BINARY WITH AUROC/AUPRC")
    ...
    stamp = (
        f"mimic3_v12_1_lstm_ann_binary_auc_"
