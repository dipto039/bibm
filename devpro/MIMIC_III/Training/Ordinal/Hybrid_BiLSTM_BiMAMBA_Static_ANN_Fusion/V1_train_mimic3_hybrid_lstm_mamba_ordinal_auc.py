...
OUT_DIR = os.path.join(_PROJECT_ROOT, "results_LOS_dynamic", "mimic3_hybrid_lstm_mamba_ordinal_auc_models_v1")
...
class HybridOrdinalModel(nn.Module):
    def __init__(self, f_dyn: int, f_static: int):
        ...
        # Dynamic = LSTM 1024 + Mamba 512 = 1536; Static = 128; Total = 1664
        self.head = build_standard_head(4 * 256 + 4 * 128 + 128, n_classes=2)  # 2 ordinal logits
