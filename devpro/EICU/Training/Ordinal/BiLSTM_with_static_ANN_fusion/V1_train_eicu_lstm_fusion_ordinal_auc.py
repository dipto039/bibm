...
eICU BiLSTM + Static ANN Fusion Ordinal 3-class LOS training script
...
Outputs:
    /lustre/home/rahas2/mimic_projects/outputs/eicu_lstm_fusion_ordinal_auc_models_v1

Run:
    python V1_train_eicu_lstm_fusion_ordinal_auc.py --workers 0 --batch 128
"""
...
def main():
    ...
    stamp = f"eicu_v1_lstm_ann_ordinal_auc_3class_H{args.hidden}_L{args.layers}_Fdyn{Xd_tr.shape[2]}_Fstat{Xs_tr.shape[1]}"
